...
if ($limit > 0) {
    imagefilledarc($im, 120, 120, 200, 200, -90, -90 + round($percent * 360), $green,
        IMG_ARC_PIE);
}
...
function drawcirc($x, $y, $bperc, $gperc, $text, $bnum, $gnum) {
    ...
    if ($bperc > 0) {
        imagefilledarc($im, $x, $y, $s, $s, -90, -90 + round($bperc * 360),
            $blue, IMG_ARC_PIE);
    }

    if ($gperc > 0) {
        imagefilledarc($im, $x, $y, $s, $s, -90 + round($bperc * 360),
            -90 + round(($gperc + $bperc) * 360), $green, IMG_ARC_PIE);
    }
